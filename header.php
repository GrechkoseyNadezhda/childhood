                ...
                <div class="row align-items-center">
                    <div class="col-11 col-sm-12 col-md-12 col-lg-3">
                        <div class="header__logo">
                            <?php the_custom_logo(); ?>
                        <div class="header__logo-text"><?php bloginfo('name'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:<?php the_field('contact_mail', 2) ?>" class="header__contacts-mail"><?php the_field('contact_mail', 2) ?></a>
                            </div>
                            <div class="header__contacts-item">
