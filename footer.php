        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="025d669" title="question-form"]'); ?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="footer__logo">
                            <?php the_custom_logo(); ?>
                            <div class="footer__logo-text"><?php bloginfo('name'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('contact_instagram', 2) ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('contact_facebook', 2) ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('contact_youtube', 2) ?>" class="footer__social-item">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            ...
                            <div class="footer__contacts-item">
                              ...
                              <address><?php the_field('contact_address', 2); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
