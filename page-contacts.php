<?php
/*
Template Name: Contacts and feedbacks
*/
?>
<?php
    get_header();
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div id="map" class="contacts__map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2563.1576389719035!2d36.221065389132704!3d50.02714191452688!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4127a13431558f91%3A0xbf3f8148f6b804d0!2sNauky%20Ave%2C%2046%2C%20Kharkiv%2C%20Kharkivs&#39;ka%20oblast%2C%20Ukraine%2C%2061000!5e0!3m2!1sen!2spl!4v1691430852392!5m2!1sen!2spl" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:+<?php the_field('contact_phone_1', 2) ?>">+<?php the_field('contact_phone_1', 2) ?></a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
                            Phone №2
                            <div class="contacts__phonewrap">
                                ...
                                <a href="tel:+<?php the_field('contact_phone_2', 2) ?>">+<?php the_field('contact_phone_2',2) ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="contacts__mail">
                        Or write us an email
                        <a href="mailto:mirdetstva@gmail.com"><?php the_field('contact_mail',2) ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="cdabfcb" title="feedback-form"]'); ?>
